...
//    }
    ...
    override fun onResume() {
        ...
        if (!isOnline) {
            Toast.makeText(context, "Offline mode: showing locally saved parcels.", Toast.LENGTH_SHORT).show()
        }
...
//        }
    ...
    private fun showSurveyedCallOutNew(
        ...
        btnStartSurvey.setOnClickListener {
            ...
            val multiMergeParcels =
                sharedPreferences.getString("multimerge_${viewModel.parcelNo}", null)
            if (!multiMergeParcels.isNullOrEmpty()) {
                Log.d("MultiMerge", "This parcel was multi-merged from: $multiMergeParcels")
                                ...
                                try {
                                    ...
                                    if (result.graphics.isNotEmpty()) {
                                        ...
                                        if (selectedMultiMergeParcels.containsKey(parcelId)) {
                                            ...
                                            selectedMultiMergeParcels[parcelId] = selectedGraphic
                                            selectedGraphic.symbol = SimpleFillSymbol(
                                                SimpleFillSymbol.Style.SOLID,
                                                Color.argb(80, 30, 144, 255),
                                                SimpleLineSymbol(
