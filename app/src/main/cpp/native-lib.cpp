...
Java_com_gop_survey_corporatefarm_MyApplication_getApiBaseUrlPublic(JNIEnv *env, jobject) {
    return env->NewStringUTF(apiBaseUrlPublic.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiCheckVersion(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_CHECK_VERSION.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiLogin(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_LOGIN.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiLoginSur(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_LOGIN_SUR.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiForgotPassword(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_FORGOT_PASSWORD.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiOtpVerification(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_OTP_VERIFICATION.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiUpdatePassword(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_UPDATE_PASSWORD.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiMauzaAssigned(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_Mauza_Assigned.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiSyncMauzaInfo(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_Sync_Mauza.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiSyncData(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_SYNC_DATA.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiPostSurveyData(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_POST_SURVEY_DATA.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiPostSurveyDataRevisit(JNIEnv *env, jobject) {
    return env->NewStringUTF(API_POST_SURVEY_DATA_REVISIT.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_gop_survey_corporatefarm_MyApplication_getApiPostSurveyDataRetakePictures(JNIEnv *env, jobject) {
